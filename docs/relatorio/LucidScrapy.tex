...
\label{SebSec:Resultados}
 ...
 O resultado final do projeto pode ser visualizado em \url{https://www.softwareengineerplayer.com/lucidscrapy}. Os resultados da execução do sistema são apresentados graficamente. Nos gráficos de receitas são apresentadas as receitas previstas, realizadas e a diferença entre o previsto e o realizado conforme\ref{Fig3}, assim como é possível exportar os gráficos em diversos formatos de imagens, por exemplo, png, jpeg, etc.
